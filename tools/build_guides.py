...
def build_user_guide() -> Path:
    ...
    add_steps(
        ...
        [
            ...
            "Approve the Windows elevation prompt. The installer builds and tests the packages, copies the matching Win32 BPLs to the public RAD Studio Bpl folder, preserves Delphi's complete Embarcadero design-package registry baseline, and registers the self-contained DAT design BPL for the current user.",
